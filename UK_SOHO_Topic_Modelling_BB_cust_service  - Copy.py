{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "df= pd.read_csv('C:\\\\Users\\\\MalikM\\\\Documents\\\\CVM TEAM -PUNE\\\\UK\\\\BB Combined\\\\input_for_topic_modelling_Cust_service.csv')"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# df3=df2[~df2['review'].isin(['1','2','3','4','5','6','7','8','9','-',''])]"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Communication and Understanding, 'Issue Resolution and Call Back','Service Quality'\n",
  ...
  },
  {
   ...
   "source": [
    "# Communication and Understanding, 'Issue Resolution and Call Back','Service Quality'\n",
    "df_dominant_topic['Topic']=np.where(df_dominant_topic['Dominant_Topic']==0.0,'Communication and Understanding',np.where(df_dominant_topic['Dominant_Topic']==1.0,'Issue Resolution and Call Back','Service Quality'))"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "Sub_Topic_Cust_Service=pd.concat([df,df_dominant_topic [['Dominant_Topic','Topic','Topic_Perc_Contrib']]], axis=1)"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [],
   "source": [
    "Sub_Topic_Cust_Service.to_csv('C:\\\\Users\\\\MalikM\\\\Documents\\\\CVM TEAM -PUNE\\\\UK\\\\OUTPUT\\\\Topic modelling output\\\\Sub_Topic_Cust_Service_BROADBAND.csv')"
   ]
  },
  {
   "cell_type": "code",
